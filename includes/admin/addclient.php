                ...
                <table class="form-table">
                    ...
                    */
                    ...
                    <tr>
                        <td>
                            <hr />
                            <label for="contact_username"><?php _e( 'Username', WPC_CLIENT_TEXT_DOMAIN ) ?> | <span style="font-size: x-small;"><?php echo sprintf( __( 'This value is used in the {user_name} placeholder that is used in HUB Templates, %s Templates &amp; Emails', WPC_CLIENT_TEXT_DOMAIN ), $this->custom_titles['portal']['s'] ) ?></span></label> <br/>
                    ...
                    */
                    ...
                    <tr>
                        <td>
                            <label for="pass1"><?php _e( 'Password', WPC_CLIENT_TEXT_DOMAIN ) ?> | <span style="font-size: x-small;"><?php echo sprintf( __( 'This value is used in the {user_password} placeholder that is used in HUB Templates, %s Templates &amp; Emails', WPC_CLIENT_TEXT_DOMAIN ), $this->custom_titles['portal']['p'] ) ?></span></label> <br/>
